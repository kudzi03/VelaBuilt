...
export const systemModules: readonly SystemModule[] = [
  {
    id: "crm",
    name: "CRM",
    role: "Every enquiry becomes a record instead of a memory.",
    flow: ["Enquiry", "Contact", "Company", "Opportunity", "Task", "Follow-up"],
  ...
  },
  {
    ...
    flow: ["Draft", "Personalise", "Send", "Track", "Reply detection"],
